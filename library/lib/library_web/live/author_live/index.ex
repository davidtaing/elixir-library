defmodule LibraryWeb.AuthorLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok,
     ...
     |> stream(
       :authors,
       Ash.read!(Library.Resource.Library.Author, actor: socket.assigns[:current_user])
     )
  ...
  defp apply_action(socket, :edit, %{"id" => id}) do
    ...
    |> assign(
      :author,
      Ash.get!(Library.Resource.Library.Author, id, actor: socket.assigns.current_user)
    )
  end
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    author = Ash.get!(Library.Resource.Library.Author, id, actor: socket.assigns.current_user)
