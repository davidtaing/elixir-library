defmodule LibraryWeb.BookLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok,
     ...
     |> stream(
       :books,
       Ash.read!(Library.Resource.Library.Book, actor: socket.assigns[:current_user])
     )
  ...
  defp apply_action(socket, :edit, %{"id" => id}) do
    ...
    |> assign(
      :book,
      Ash.get!(Library.Resource.Library.Book, id, actor: socket.assigns.current_user)
    )
  end
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    book = Ash.get!(Library.Resource.Library.Book, id, actor: socket.assigns.current_user)
